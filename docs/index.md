...
features:
  ...
  - icon: 🖼️
    ...
    details: Process images and audio with vision-language models like LLaVA, Qwen2-VL, and LFM2-VL with the same ease as text-only models
    link: /guide/multimodal
    linkText: Learn more
